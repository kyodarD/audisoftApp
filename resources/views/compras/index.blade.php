                                ...
                                <tbody>
                                    @foreach($compras as $compra)
                                        <tr>
                                            ...
                                            <td>
                                                {{-- Cambio de estado => "editar compras" (o uno aparte si lo deseas) --}}
                                                @can('editar compras')
                                                    <input data-type="compras"
                                                           data-id="{{ $compra->id }}"
                                                           class="toggle-class"
                                                           type="checkbox"
                                            ...
                                            <td>
                                                {{-- Mostrar compra => "mostrar compras" --}}
                                                @can('mostrar compras')
                                                ...
                                                {{-- Eliminar => lo ponemos bajo "editar compras" o un permiso propio "eliminar compras" --}}
                                                @can('editar compras')
