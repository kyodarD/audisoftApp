...
<head>
    ...
    <!-- Select2 -->
    <link rel="stylesheet" href="{{ secure_asset('backend/plugins/select2/css/select2.min.css') }}">
    <link rel="stylesheet" href="{{ secure_asset('backend/plugins/select2-bootstrap4-theme/select2-bootstrap4.min.css') }}">
    <link rel="stylesheet" href="{{ secure_asset('backend/dist/css/select2.css') }}">
    
    <!-- Bootstrap Color Picker -->
    <link rel="stylesheet" href="{{ secure_asset('backend/plugins/bootstrap-colorpicker/css/bootstrap-colorpicker.min.css') }}">
    <link rel="stylesheet" href="{{ secure_asset('backend/plugins/bootstrap-datepicker/dist/css/bootstrap-datepicker.min.css') }}">
    
    <!-- Bootstrap4 Duallistbox -->
    <link rel="stylesheet" href="{{ secure_asset('backend/plugins/bootstrap4-duallistbox/bootstrap-duallistbox.min.css') }}">
    
    <!-- BS Stepper -->
    <link rel="stylesheet" href="{{ secure_asset('backend/plugins/bs-stepper/css/bs-stepper.min.css') }}">
    
    <!-- Dropzone -->
    <link rel="stylesheet" href="{{ secure_asset('backend/plugins/dropzone/min/dropzone.min.css') }}">
...
<!-- Select2 -->
<script src="{{ secure_asset('backend/plugins/select2/js/select2.full.min.js') }}"></script>	

<!-- Bootstrap4 Duallistbox -->
<script src="{{ secure_asset('backend/plugins/bootstrap4-duallistbox/jquery.bootstrap-duallistbox.min.js') }}"></script>

<!-- InputMask -->
<script src="{{ secure_asset('backend/plugins/inputmask/jquery.inputmask.min.js') }}"></script>

<!-- Bootstrap Picker -->
<script src="{{ secure_asset('backend/plugins/bootstrap-colorpicker/js/bootstrap-colorpicker.min.js') }}"></script>
<script src="{{ secure_asset('backend/plugins/bootstrap-daterangepicker/daterangepicker.js') }}"></script>
<script src="{{ secure_asset('backend/plugins/bootstrap-datepicker/dist/js/bootstrap-datepicker.min.js') }}"></script>
<script src="{{ secure_asset('backend/plugins/bootstrap-datepicker/dist/locales/bootstrap-datepicker.es.min.js') }}"></script>

<!-- Bootstrap Switch -->
<script src="{{ secure_asset('backend/plugins/bootstrap-switch/js/bootstrap-switch.min.js') }}"></script>

<!-- BS-Stepper -->
<script src="{{ secure_asset('backend/plugins/bs-stepper/js/bs-stepper.min.js') }}"></script>

<!-- Dropzonejs -->
<script src="{{ secure_asset('backend/plugins/dropzone/min/dropzone.min.js') }}"></script>

<!-- Select2 -->
<script src="{{ secure_asset('backend/dist/js/select2.js') }}"></script>
...
<!-- Custom JS -->
<script src="{{ secure_asset('backend/dist/js/table.js') }}"></script>
<script src="{{ secure_asset('backend/dist/js/statuschange.js') }}"></script>
<script src="{{ secure_asset('backend/dist/js/delete-confirm.js') }}"></script>
<script src="{{ secure_asset('backend/dist/js/selectors.js') }}"></script>
